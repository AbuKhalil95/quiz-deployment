<div class="modal fade" id="updatePermissionModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addModalLabel">Update Permission</h5>
