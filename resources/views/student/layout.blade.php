...
<body>
    <div class="app-container">
        ...
        <div class="app-header">
            <div
                class="container d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between">
                <h1 class="app-title mb-2 mb-md-0">
                    <a class="navbar-brand" href="{{ route('student.dashboard') }}">HKMLE Quiz Practice</a>
                </h1>
