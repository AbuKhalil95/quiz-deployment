  ...
  if (collapsible === "none") {
    return (
      <div
        ...
        style={{ width: SIDEBAR_WIDTH, ...sidebarWidthStyle } as React.CSSProperties}
        {...props}
      >
        {children}
      </div>
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        <SheetContent
          ...
          style={{ width: SIDEBAR_WIDTH_MOBILE, ...sidebarWidthStyle } as React.CSSProperties}
          side={side}
        >
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "peer-data-[variant=inset]:min-h-[calc(100svh-(--spacing(4)))] md:peer-data-[variant=inset]:m-0 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-0",
        className
      )}
      {...props}
    />
