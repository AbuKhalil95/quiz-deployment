...
export default function Browse({
    ...
    const applyFilters = () => {
        ...
        if (targetStudentId) params.set("target_student_id", targetStudentId);

        router.get(route("student.adaptive.index"), Object.fromEntries(params), {
            preserveState: true,
            preserveScroll: true,
        });
    };
                ...
                <Card className="mb-6">
                    ...
                    <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="target_student">Target Student</Label>
                                <Select
